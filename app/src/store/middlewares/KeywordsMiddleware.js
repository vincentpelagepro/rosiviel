...
// reducer
import { GET_DATA_FROM_API_TO_KEYWORDS, saveDataFromApi } from '../reducers/KeywordsReducer';
 ...
 * Code
 */
const KeywordsMiddleware = store => next => (action) => {
  // récupérer les dates
  ...
  switch (action.type) {
    case GET_DATA_FROM_API_TO_KEYWORDS: {
      ...
      // ajax
      axios
        .post(`${axiosBasepath}keywords/api`, {
        ...
        .catch(() => {
          // console.log('KeywordsMiddleware : getData n\'est pas passé');
        });
      break;
    }
    default:
 ...
 * Export default
 */
export default KeywordsMiddleware;
