...
// reducer
import { GET_DATA_FROM_API_TO_CAMPAIGNS, saveDataFromApi } from '../reducers/CampaignsReducer';
 ...
 * Code
 */
const CampaignsMiddleware = store => next => (action) => {
  // récupérer les dates
  ...
  switch (action.type) {
    case GET_DATA_FROM_API_TO_CAMPAIGNS: {
      ...
      // ajax
      axios
        .post(`${axiosBasepath}campaigns/api`, {
        ...
        .catch(() => {
          // console.log('CampaignsMiddleware : getData n\'est pas passé');
        });
      break;
    }
    default:
